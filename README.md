# Node.js : JSON Server <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />


### What is in there
This GitHub repository is just a simple json server program using json-server module.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-json-server
cd nodejs-json-server
npm install
npm run json:server
```
